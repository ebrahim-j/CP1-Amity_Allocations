...
class TestAmity(unittest.TestCase):
    ...
    def test_whether_nonexisting_person_not_added(self):
       ...
       reallocate =self.amity.reallocate_person("THE MACE", "Mogadishu")
    ...
    def test_if_newroom_doesnt_exists(self):
       self.amity.add_person("THE","CYBORG", "STAFF", "N")
       reallocate =self.amity.reallocate_person("THE CYBORG", "Mombasa")
    ...
    def test_if_identifier_doesnt_exist(self):
       self.amity.create_room("o", "Mombasa")
       reallocate =self.amity.reallocate_person("THE ROCK", "Mombasa")
    ...
    def test_newroom_is_not_full(self):
       ...
       reallocate =self.amity.reallocate_person("THE THING", "Mombasa")
    ...
    def test_if_reallocation_successful(self):
       ...
       reallocate =self.amity.reallocate_person("THE ROCK", "Mogadishu")
    ...
    def test_people_loaded(self):
       response = self.amity.load_people("text.txt")
